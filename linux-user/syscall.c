                    ...
                    abi_long arg8)
{
    ...
    /* Microhook pre-syscall hook */
    if (microhook_enabled()) {
        hooked = microhook_pre_syscall(cpu_env, num,
                                      arg1, arg2, arg3, arg4,
                                      arg5, arg6, arg7, arg8,
                                      &hook_result);
        if (hooked) {
            ...
            if (hook_result.action == MICROHOOK_SKIP) {
                ret = hook_result.ret;
    ...
    /* Microhook post-syscall hook */
    if (microhook_enabled()) {
        ret = microhook_post_syscall(cpu_env, num, ret,
                                    arg1, arg2, arg3, arg4,
                                    arg5, arg6, arg7, arg8);
    }
